...
// Yurij eu2av - Updated device family from Cyclone IV GX to Cyclone IV E - 2026-06-09
// - Original IP created in Quartus 17.0.2 Build 232
// - Changed DEVICE_FAMILY and INTENDED_DEVICE_FAMILY to match target device
// - Fixes Warning 169180 (clamping diode) caused by GX vs E mismatch
...
//
// 17.0.2 Build 232 06/12/2013 SP 1 SJ Web Edition
// ************************************************************
...
//synthesis_resources = a_graycounter 5 cycloneii_asmiblock 1 lpm_compare 2 lpm_counter 2 lut 70 mux21 1 reg 121 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  ASMI_altasmi_parallel_smm2
	( 
	addr,
	bulk_erase,
	busy,
...
`endif
	...
	( 
	.aclr(reset),
	.clk_en(((((((((do_write | do_sec_erase) | do_bulk_erase) | do_die_erase) & (~ write_prot_true)) | do_4baddr) & end_wrstage) & (~ st_busy_wire)) | clr_write_wire2)),
	.clock((~ clkin_wire)),
	...
	always @ ( posedge clkin_wire or  posedge reset)
		...
		else  clr_rstat_reg <= ((end_operation | do_read_sid) | do_read);
	// synopsys translate_off
	initial
		clr_secprot_reg = 0;
	// synopsys translate_on
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  clr_write_reg <= ((((((((((((((do_write | do_sec_erase) | do_bulk_erase) | do_die_erase) | do_4baddr) & wire_wrstage_cntr_q[1]) & (~ wire_wrstage_cntr_q[0])) & end_operation) | write_prot_true) | (do_write & (~ pagewr_buf_not_empty[8]))) | ((((((~ do_write) & (~ do_sec_erase)) & (~ do_bulk_erase)) & (~ do_die_erase)) & (~ do_4baddr)) & end_operation)) | do_read_sid) | do_sec_prot) | do_read) | do_fast_read);
	// synopsys translate_off
	initial
		clr_write_reg2 = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clkin_wire or  posedge reset)
		if (reset == 1'b1) write_prot_reg2 <= 1'b0;
		else  write_prot_reg2 <= write_prot_reg;
	// synopsys translate_off
	initial
		write_reg = 0;
	// synopsys translate_on
	...
	always @ ( posedge clkin_wire or  posedge reset)
		if (reset == 1'b1) write_rstat_reg <= 1'b0;
			...
			else  write_rstat_reg <= (((((do_write | do_sec_erase) | do_bulk_erase) | do_die_erase) | do_4baddr) & (((~ wire_wrstage_cntr_q[1]) & (~ wire_wrstage_cntr_q[0])) | (wire_wrstage_cntr_q[1] & (~ wire_wrstage_cntr_q[0]))));
	// synopsys translate_off
	initial
		wrstat_dreg[0:0] = 0;
	// synopsys translate_on
	...
	assign
		...
		do_read_rdid = 1'b0,
		do_read_sid = 1'b0,
		do_read_stat = (((((((((~ read_rdid_wire) & (~ read_sid_wire)) & (~ sec_protect_wire)) & (~ (read_wire | fast_read_wire))) & (~ write_wire)) & read_status_wire) | do_write_rstat) | do_sprot_rstat) | do_write_volatile_rstat),
		...
		do_write_polling = ((((((do_write | do_sec_erase) | do_bulk_erase) | do_die_erase) | do_4baddr) & wire_wrstage_cntr_q[1]) & (~ wire_wrstage_cntr_q[0])),
		...
		illegal_write_b4out_wire = (((do_write & write_prot_true) | (illegal_write_prot & write_prot_true2)) | (do_write & (~ pagewr_buf_not_empty[8]))),
...
endmodule //ASMI_altasmi_parallel_smm2
//VALID FILE
...
module ASMI (
	...
	wire  sub_wire3;
	wire  sub_wire4;
	wire  data_valid = sub_wire0;
	wire  illegal_erase = sub_wire1;
	wire [7:0] dataout = sub_wire2[7:0];
	wire  busy = sub_wire3;
	wire  illegal_write = sub_wire4;

	ASMI_altasmi_parallel_smm2	ASMI_altasmi_parallel_smm2_component (
